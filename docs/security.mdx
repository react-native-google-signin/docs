...
The authentication APIs in [Universal Sign-In](/docs/one-tap) for Apple, Android and web allow you to specify nonce. On native platforms, if it's not specified, a cryptographically random value is generated internally.
