...
<details>
    ...
    <Image img={require('/img/onetap/signing-in.png')} style={{maxWidth: 400}} />
</details>
...
It should be used if `signIn` rejects with [`NO_SAVED_CREDENTIAL_FOUND`](errors#status-codes-specific-to-one-tap-sign-in) error, as shown in the code snippet above. You don't need to call `createAccount` as a response to a user action - you can call it when your app starts or when suitable.
...
<details>
    <summary>UI screenshot</summary>
    <Image img={require('/img/onetap/signing-up.png')} style={{maxWidth: 400}} />
</details>
...
On the web, this call rejects - please use the Sign in button instead. [Read below](#web-support) for web support.

<details>
    <summary>UI screenshot</summary>
    <Image img={require('/img/onetap/explicit.png')} style={{maxWidth: 400}} />
</details>
