...
| `authenticate`          | (`params?`: [`OneTapAuthenticateParams`](index.mdx#onetapauthenticateparams)) => `Promise`\<[`OneTapAuthenticateResponse`](index.mdx#onetapauthenticateresponse)\>         |
