...
<TabItem value="cloud-console" label="When not using Firebase">
  _For each_ of the SHA-1 fingerprints you obtained, create an OAuth Client ID of type Android in [Google Cloud Console](https://console.cloud.google.com/apis/credentials?project=_) - see the screenshot below.
