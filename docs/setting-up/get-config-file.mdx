...
<Tabs>
  ...
  <TabItem value="local" label="When developing locally">
    ...
    2. Scroll to the top of output, see the fingerprints. Debug fingerprint is used in dev, release fingerprint is used for release APK.
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="cloud-console" label="When not using Firebase">
    Follow the "To create an OAuth 2.0 client ID in the console" instructions [here](https://support.google.com/cloud/answer/6158849?hl=en).
  </TabItem>
