...
Available on the public npm registry, this version does not include One-tap sign-in (it uses the functional, but deprecated [legacy Google Sign-In for Android](https://web.archive.org/web/20240308064911/https://developers.google.com/identity/sign-in/android/start-integrating)), Web and macOS support found in the sponsor-only version.
