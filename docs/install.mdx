...
You can get access either [by sponsoring](https://github.com/sponsors/vonovak) (use specifically the tiers that mention this project!) or as an Expo customer through [this form](https://forms.gle/tpP7TfUGW1CwgaEZ8). Note that this version is distributed under a [custom license](license). You will receive an invitation to access the private repo with the sources and examples, as well as to the private npm package.
...
1. [Become a sponsor](https://github.com/sponsors/vonovak) or [complete the form](https://forms.gle/tpP7TfUGW1CwgaEZ8) and accept the private repository invitation.
